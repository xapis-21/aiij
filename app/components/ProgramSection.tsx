...
const ProgramSection = ({
  ...
  return (
    <div
      className={`flex gap-8 items-start max-w-[1280px] mx-auto px-4 md:px-2 ${style} `}
    >
      <div
        ...
        <ul className="flex flex-col items-start gap-y-8">
          {benefits?.map((benefit, i) => (
            <li className="flex gap-4">
              <span className="rounded-full text-white  bg-iyellow grid place-items-center font-heading text-xl p-2">
                {i + 1}
              </span>
              <p>{benefit}</p>
            </li>
